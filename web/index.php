  ...
  <body>
    <div class="row" style="margin-top: 20px;">
      <div class="col-md-8 col-md-offset-2">
        ...
        <br />
        <a id="light_clin" href="?light=clin" class="btn btn-warning btn-block btn-lg">clignote</a>
        <br />
        ...
        <div class="light-status well" style="margin-top: 5px; text-align:center;">
           <img id="light_img_on" src="on.png" style="height:200px;">
           <img id="light_img_off" src="off.png" style="height:200px;">
        </div>
      </div>
    </div>
  </body>
